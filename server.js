...
// ============================================================
// API: REGISTER BUSINESS (WITH IMAGE & VIDEO USING MULTER)
// ============================================================
app.post('/api/register-business', requireActiveClaim, upload.fields([
  ...
  try {
    ...
    // 3. Parse location (if JSON string)
    ...
    // 4. Save to database (update businesses table)
