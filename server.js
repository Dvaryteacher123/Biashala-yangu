...
app.post('/api/businesses', requireActiveClaim, async (req, res) => {
  const { userId, name, category, description, address, phone, website, imageUrl } = req.body;
...
app.put('/api/businesses/:id', requireActiveClaim, async (req, res) => {
  const { id } = req.params;
  const { userId, name, category, description, address, phone, website, imageUrl, isActive, isPro } = req.body;
...
// ============================================================
// API: UPLOAD IMAGE (Requires Active Claim)
// ============================================================
