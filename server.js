...
// Mfumo wa Render uko nyuma ya Proxy, hii ni lazima ili Cookies ziweze kutunzwa kwenye HTTPS
...
// Session — Mipangilio iliyorekebishwa kwa ajili ya Render (HTTPS Proxy)
app.use(session({
  ...
  proxy: true,
  cookie: {
    maxAge: 1000 * 60 * 60 * 24, // Siku 1
    secure: process.env.NODE_ENV === 'production' || true, // Hakikisha cookie inatumwa kwa HTTPS kwenye Render
    sameSite: 'lax'
  }
}));
