...
function requireMainAdmin(req, res, next) {
  ...
  // Hii itatusaidia kuona kwenye logs nini kipo kwenye session
  ...
  // Kama hakuna user
  if (!user) {
    console.log("[BLOCKED] Hakuna user kwenye session, naelekeza login.");
  ...
  console.log(`Checking Email: '${userEmail}' vs Target: '${ADMIN_EMAIL.toLowerCase()}'`);

  // Linganisha email
  if (userEmail !== ADMIN_EMAIL.toLowerCase()) {
    console.log(`[ADMIN BLOCKED] ${userEmail || 'Unknown user'} si admin mkuu.`);
    return res.redirect('/');
  }

  console.log("[SUCCESS] Admin mkuu kapita salama!");
  next();
}
